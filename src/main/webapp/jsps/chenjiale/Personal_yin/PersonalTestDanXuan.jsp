...
<script type="text/javascript">
    function danxuanok(){
        ...
        var data = new FormData($("#danxuanform")[0]);
        $.ajax({
            type: "post",
...
<div class="modal fade" id="danxuan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" class="form-horizontal" role="form" id="danxuanform">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        A：<input type="radio" name="answer" value="A"><br/>
                        B：<input type="radio" name="answer" value="B"><br/>
                        C：<input type="radio" name="answer" value="C"><br/>
