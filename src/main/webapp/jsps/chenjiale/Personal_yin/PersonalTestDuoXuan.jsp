...
<script type="text/javascript">
    function duoxuanok(){
        ...
        var data = new FormData($("#duoxuanform")[0]);
        $.ajax({
            type: "post",
...
<%--多选--%>
<div class="modal fade" id="duoxuan" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" class="form-horizontal" role="form" id="duoxuanform">

                <input type="hidden" class="control" name="questionid">
                <input type="hidden" class="control" name="userid">
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-4">
                        A：<input type="checkbox" name="answer" value="A"><br/>
                        B：<input type="checkbox" name="answer" value="B"><br/>
                        C：<input type="checkbox" name="answer" value="C"><br/>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" onclick="duoxuanok()">确定</button>
