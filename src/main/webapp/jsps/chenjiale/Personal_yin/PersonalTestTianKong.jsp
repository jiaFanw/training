...
<script type="text/javascript">
    function tiankongok(){
        ...
        var data = new FormData($("#tiankongform")[0]);
        $.ajax({
            type: "post",
...
<div class="modal fade" id="tiankong" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <form method="post" class="form-horizontal" role="form" id="tiankongform">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal" onclick="tiankongok()">确定</button>
